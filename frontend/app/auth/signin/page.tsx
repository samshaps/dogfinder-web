    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white flex items-center justify-center px-4">
      <div className="max-w-md w-full bg-white rounded-2xl shadow-lg border border-gray-200 p-8">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-gray-900 mb-2">Welcome to DogYenta</h1>
          <p className="text-gray-600">
            Sign in to save your preferences and get personalized dog matches
          </p>
        </div>
        ...
        <Suspense fallback={
          <button
            disabled
            className="w-full bg-blue-400 text-white font-semibold py-3 px-6 rounded-lg flex items-center justify-center gap-3 cursor-not-allowed"
          >
            Loading...
          </button>
        }>
