      ...
      <section className="py-6 sm:py-8">
        <div className="mx-auto max-w-[800px] px-4 sm:px-6">
          ...
          <div className="text-center mb-6">
            <h1 className="text-[28px] sm:text-[32px] font-extrabold text-slate-900 mb-2">About Yenta</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            <section className="bg-white rounded-lg shadow-sm border border-slate-200 p-5 text-left">
              ...
              <div className="text-[15px] text-slate-600 leading-7">
                <p>
            ...
            <section className="bg-white rounded-lg shadow-sm border border-slate-200 p-5 text-left">
              ...
              <div className="text-[15px] text-slate-600 leading-7 space-y-3">
                <p>
