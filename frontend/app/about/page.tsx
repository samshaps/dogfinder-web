      ...
      <section className="py-10 sm:py-12">
        <div className="mx-auto max-w-[800px] px-6">
          ...
          <div className="text-center mb-10">
            <h1 className="text-[28px] sm:text-[32px] font-extrabold text-slate-900 mb-3">About Yenta</h1>
          ...
          <div className="space-y-8">
            {/* How We Help */}
            <section className="bg-white rounded-lg shadow-sm border border-slate-200 p-6 text-left">
              <h2 className="text-[18px] sm:text-[20px] font-semibold mb-3">How We Help</h2>
              <div className="text-[15px] text-slate-600 leading-7 space-y-4">
                <p>
